...
impl McpPicker {
    ...
    pub fn handle_key(&mut self, key: KeyEvent) -> McpPickerAction {
        match self.picker.handle_key(key) {
            ...
            PickerAction::Select(..) | PickerAction::Close | PickerAction::Delete(..) => {
                McpPickerAction::Close
            }
        }
    }
        ...
        McpSnapshotReader::from_snapshot(McpSnapshot {
            infos: vec![
                McpServerInfo {
                    ...
                    config_path: PathBuf::from("/home/.config/makima/config.toml"),
                    url: None,
                    oauth: None,
                },
                McpServerInfo {
                    ...
                    config_path: PathBuf::from("/project/.makima/config.toml"),
                    url: None,
                    oauth: None,
                },
            ],
